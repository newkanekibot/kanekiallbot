...
from kaneki import EVENT_LOGS
from kaneki import pbot as app
from kaneki.arqclient import arq
from kaneki.core.tasks import _get_tasks_text, all_tasks, rm_task
from kaneki.core.types import InlineQueryResultCachedDocument
from kaneki.extrastuff import SUDOERS
from kaneki.modules.info import get_chat_info, get_user_info
from kaneki.modules.media import download_youtube_audio
from kaneki.utils.functions import test_speedtest
from kaneki.utils.keyboard import ikb
from kaneki.utils.pastebin import paste
...
async def inline_help_func(__help__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/c639dd783adfaa50dec58.jpg",
            reply_markup=buttons,
        ),
        InlineQueryResultArticle(
            title="Support",
            description="Official Kaneki Support.",
            input_message_content=InputTextMessageContent(
                "https://t.me/TebBotSupport"
            ),
            thumb_url="https://telegra.ph/file/c639dd783adfaa50dec58.jpg",
        ),
    ]
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/KanekiMusicbot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Kaneki](https://t.me/TebBotSupport)**
**MainBot:** `{bot_state}`
...
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Kaneki Status",
            thumb_url="https://telegra.ph/file/c639dd783adfaa50dec58.jpg",
            input_message_content=InputTextMessageContent(
...
async def speedtest_init(query):
    ...
    button.add(InlineKeyboardButton(text="Start!", callback_data="test_speedtest"))
    answers.append(
        InlineQueryResultArticle(
            title="Click Here",
            input_message_content=InputTextMessageContent(msg),
