...
from kaneki.modules.redis.afk_redis import afk_reason, is_user_afk
...
def info(update: Update, context: CallbackContext):
    ...
    if user_id not in [bot.id, 777000, 1982138294]:
        userhp = hpmanager(user)
        text += f"\n\n<b>Health:</b> <code>{userhp['earnedhp']}/{userhp['totalhp']}</code>\n[<i>{make_bar(int(userhp['percentage']))} </i>{userhp['percentage']}%]. [<a href='https://t.me/TebMusicUpdate/15'>?</a>]"
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/TebMusicUpdate/14">?</a>]'.format(
            bot.username,
        )
            ...
            context.bot.send_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/TebMusicUpdate/15"
                            ),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/TebMusicUpdate/14"
                            ),
                        ],
                        [
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(
            ...
            + f"\n\n[🔥 Support](https://t.me/TebBotSupport) | [🔥 Movie Channel](https://t.me/SkyBotId)\n\n"
            + "╘══「 by [Cyberhunt](https://t.me/Cyberhunt27) 」\n",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
        )
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text(
                "Erm... yeah, I only trust the Cyberhunt27 to set my bio.",
            )
            return
...
⇝ Come and see [HP System explained](https://t.me/TebBotSupport/26469)
"""
