    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id in DEV_USERS:
                update.effective_message.reply_text(
                    "Whoa! A VIP member of the Kaneki Music just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            if new_mem.id in DEMONS:
                update.effective_message.reply_text(
                    "Whoa! Someone with a Demons Users just joined!",
                    reply_to_message_id=reply,
                )
                continue
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "See you later at Kaneki Music!", reply_to_message_id=reply
                )
                return
            ...
            if left_mem.id in DEV_USERS:
                update.effective_message.reply_text(
                    "See you later at the Kaneki Music!",
                    reply_to_message_id=reply,
                )
                return
