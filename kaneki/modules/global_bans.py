...
from kaneki.modules.helper_funcs.extraction import extract_user, extract_user_and_text
...
def gban(update: Update, context: CallbackContext):
    ...
    if int(user_id) in DEV_USERS:
        message.reply_text(
            "That user is member of the Idz Syndicates I can't act against our own.",
        )
        return
    ...
    if user_id == bot.id:
        message.reply_text("You uhh...want me to Destroy myself?")
        return
...
🔘 *Note:* Users can appeal spamwatch bans at @TebBotSupport
"""
