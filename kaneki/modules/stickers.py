...
from kaneki import telethn as bot
from kaneki.events import register as Kaneki
...
def makepack_internal(
    ...
    if success:
        ...
        msg.reply_text("Failed to create sticker pack. Possibly due to power magic.")
...
Credit = "This Plugin Made by Kaneki (@Cyberhunt27), if you're using this code in your bot. there is no issue but don't remove this line"
...
async def drawText(image_path, text):
    ...
    if os.name == "nt":
        ...
        fnt = "./kaneki/resources/Chopsic.otf"
