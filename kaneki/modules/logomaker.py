...
from kaneki import OWNER_ID, telethn as tbot
from kaneki.events import register

LOGO_LINKS = [
    "https://telegra.ph/file/e5ac1fa299309aeac3d08.jpg",
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./kaneki/kanekilogo/*")
        ...
        await tbot.send_file(
            event.chat_id, file=fname, caption=f"Made by @KANEKIMUSICBOT"
        )
        await pesan.delete()
        if os.path.exists(fname):
            os.remove(fname)
    except Exception as e:
        await event.reply(f"Error, Report @TEBBOTSUPPORT, {e}")
