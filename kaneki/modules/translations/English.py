...
<code>[hyperlink](example.com)</code> this is used for <code>[hyperlink](http://example.com/)</code>, and will show as such: hyperlink. Make sure not to add any extra spaces between the ] and the ( or it won't be valid markdown.
...
EnglishStrings = {
    "send-start": """Hi {}, my name {}! If you have any questions on how to use me, read /help - and then head to @TebBotSupport.

I'm a group manager bot maintained by [Cyberhunt27](http://t.me/Cyberhunt27). I'm a [Marie](https://github.com/PaulSonOfLars/tgbot) fork.
