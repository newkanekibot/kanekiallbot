...
from kaneki.modules.helper_funcs.readable_time import get_readable_time
from kaneki.modules.sql import users_sql as sql

HELP_MSG = "Click The Button Below To Get Help Menu In Your Private Message."
HELP_IMG = "https://telegra.ph/file/7969f5e21d87a7778b824.png"
GROUP_START_IMG = (
    "CAACAgIAAx0CXBdkHQAC34lhpHKAV3nIlqfcnYmDkIhbOFTktwACFBAAAkXe2EuBs3crQ6mMdR4E"
)

PM_START_TEXT = """
Hello there, [👋](https://telegra.ph/file/e5ac1fa299309aeac3d08.jpg) I'm {}.
Im Powerfull Management Bot And I Will Help In Managing Your Group.
Maintained by : [Cyberhunt](https://t.me/Cyberhunt27)
Founder And Dev Of : [KANEKI MUSIC](https://t.me/TebBotSupport).
➖➖➖➖➖➖➖➖➖➖➖➖➖
• *Uptime:* `{}`
• `{}` *Users, across* `{}` *chats.*
➖➖➖➖➖➖➖➖➖➖➖➖➖
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text=" ➕ ｢ Summon Me 」➕ ",
            url="t.me/TebErickMusik_bot?startgroup=true",
        ),
    ],
    [
        InlineKeyboardButton(text=" ｢ Support 」", url="http://t.me/TebBotSupport"),
        InlineKeyboardButton(text=" [❌] ", callback_data="close"),
        InlineKeyboardButton(text=" ｢ Update 」", url="http://t.me/TebMusicUpdate"),
    ],
]


HELP_STRINGS = f"""
*Main Commands :* [Kaneki Music](https://telegra.ph/file/e5ac1fa299309aeac3d08.jpg)
...
DONATE_STRING = """Hello, glad to hear you want to donate!
 You can support the project via [pulsa](#) or by contacting @Cyberhunt27\
        ...
        message.reply_animation(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Support", url=f"https://telegram.dog/TebBotSupport"
                        ),
                        InlineKeyboardButton(
                            text="Updates", url="https://telegram.dog/TebMusicUpdate"
                        ),
                    ],
                ]
            ),
            ...
            query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton(
                                text="Support", url="https://t.me/TebBotSupport"
                            ),
                        ],
                    ]
                ),
...
def kaneki_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\n 🔥 Join [Kaneki Music](https://t.me/TebBotSupport) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
            ...
            f"\n\n If you have any question about *Kaneki*, let us know at @TebBotSupport."
            f"\n\n👇 You Can Know More About *Kaneki* By Clicking The Below Buttons 👇",
            parse_mode=ParseMode.MARKDOWN,
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [support](https://t.me/TebBotSupport).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            text=f"*Kaneki Is the redisigned version of Daisy and Saitama And Othrer for the best performance.*"
            f"\n\nKaneki source code was rewritten by @IdzXartez and All Of Conrtibutor For Help Kaneki"
            f"\n\nIf Any Question About kaneki, \nLet Us Know At @TebBotSupport.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n✪ Always try to keep credits, so \n  This hardwork is done by @Cyberhunt27 spending many sleepless nights.. So, Respect it."
            f"\n✪ Some modules in this bot is owned by different authors, So, \n  All credits goes to them \n  Also for <b>Paul Larson for Marie</b>."
            f"\n✪ If you need to ask anything about \n  this bot, Go @TebBotSupport."
            f"\n✪ If you asking nonsense in Support \n  Chat, you will get warned/banned."
            f"\n✪ All api's we used owned by originnal authors \n  Some api's we use Free version \n  Please don't overuse AI Chat."
            f"\n\nFor any kind of help, related to this bot, Join @TebBotSupport."
        ...
        query.message.edit_text(
            ...
            f"\n📌 **if the userbot not joined to video chat, make sure if the video chat already turned on, or you can ask Admins in @TebBotSupport.**\n"
            f"\n⚡ __Powered by Kaneki A.I__\n",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@TebBotSupport", "⚡️")
        except Unauthorized:
            LOGGER.warning(
    ...
    about_callback_handler = CallbackQueryHandler(
        kaneki_about_callback, pattern=r"aboutmanu_", run_async=True
    )
